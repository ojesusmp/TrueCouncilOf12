# COUNCIL OF 12 — REPORT TEMPLATES

This file contains the output templates for Mode B (Full Council) and Mode C (Full Pipeline).
Mode A output is embedded directly in SKILL.md and is not here.

---

# MODE B TEMPLATE — Full Council Report
...
**Phase summary:** [2-3 sentences capturing the reality established by Seats 1-3. What do we now know for certain? What is the ground truth this analysis must stand on?]
...
**Phase summary:** [2-3 sentences capturing the constraints identified by Seats 4-6. What are the non-negotiable limits? What ethical and human factors define the decision space?]
...
**Phase summary:** [2-3 sentences capturing the expanded perspective from Seats 10-12. What becomes possible? What was missed before this phase?]
...
**Verdict:** [PROCEED | REVISE — needs: <specific missing input> | STOP] — one clear, actionable sentence. Not a direction — a decision. Executable tomorrow.
...
**Tradeoff:** [What is sacrificed and why it's worth it — "We sacrifice X to protect Y because Z"]

**Confidence:** [High / Medium / Low — cite how many seats converge on this verdict vs. how many dissent, and which dissenting seats carry the most weight]
...
| Action | Category | Timeframe | Effort | Impact | Owner |
|--------|----------|-----------|--------|--------|-------|
| [action 1] | Do Now | Immediate | [L/M/H] | [L/M/H] | [who] |
| [action 2] | Do Now | Immediate | [L/M/H] | [L/M/H] | [who] |
| [action 3] | Invest Now | This quarter | [L/M/H] | [L/M/H] | [who] |
| [action 4] | Invest Now | This quarter | [L/M/H] | [L/M/H] | [who] |
| [action 5] | Defer | When ready | [L/M/H] | [L/M/H] | [who] |
| [action 6] | Defer | When ready | [L/M/H] | [L/M/H] | [who] |

**Categories:**
- **Do Now:** Immediate actions with a clear path — delay has direct cost
- **Invest Now:** Requires significant effort or coordination but pays off — start planning now
- **Defer:** Not urgent, not blocking — revisit when conditions change or capacity opens

### Strategic Applications

**Tier 1 — Direct:** [How to apply the verdict to the immediate situation. This is what to do with this specific analysis today.]

**Tier 2 — Adjacent:** [How insights from this analysis apply to related situations the user hasn't asked about. What other domains, decisions, or relationships does this pattern illuminate?]

**Tier 3 — Breakthrough:** [The non-obvious, paradigm-shifting insight that only emerges from seeing all 12 seats together. This is the "Dr. House moment" — the thing that looks like a detail until you realize it changes the diagnosis entirely. What does the full council see that no single perspective could see alone?]
...
**Tradeoff:** [What is sacrificed and why it's worth it — detailed version with acknowledgment of what's genuinely lost, not just minimized. "We sacrifice X to protect Y because Z, and we accept the cost of losing X because..."]

**Confidence:** [High / Medium / Low — with detailed seat alignment analysis. How many seats converge? Which seats dissent most forcefully? What would flip this from Medium to High, or from High to Medium?]

**Dissenting seats:** [Which seats would disagree most strongly with this verdict, and why their objection matters even though Solomon overrules it. A good verdict takes the dissent seriously rather than dismissing it.]

**Time horizon:**
- **1 week:** [immediate effects, what needs to happen first]
- **1 month:** [early indicators of success or failure, what to watch]
- **1 year:** [expected state if the verdict is executed well]
- **5 years:** [downstream consequences, legacy effects, what this decision becomes over time]

**Reversibility:** [Can this be undone? At what point does the decision become irreversible? What is the point of no return, and how much time is there to course-correct if signals go wrong?]
...
## Adaptive Language Guide

The report templates above use placeholder labels. Adapt language to the domain of the situation being analyzed.

### Technical Domain
- Use: findings, deliverable, priority, code review, architecture, implementation
- Tone: precise, evidence-driven, actionable — lead with data
- Seat output style: bullet points with code references, metrics, or system behavior citations
- Verdict language: "implement", "ship", "revert", "refactor", "deprecate"

### Legal Domain
- Replace "findings" with "observations"; replace "deliverable" with "filing" or "document"
- Replace "priority: HIGH" with "urgent consideration" or "material consideration"
- Tone: measured, precise, defensible — every claim must be supportable
- Seat output style: structured paragraphs with citations to precedent, statute, or record
- Verdict language: "advise", "proceed", "withdraw", "disclose", "preserve"
- Never use: "hack", "workaround", "ship it", "good enough", "fast"

### Personal Domain (career, relationships, family, health)
- Replace "findings" with "insights"; replace "deliverable" with "decision" or "situation"
- Replace "priority: HIGH" with "what matters most" or "what needs your attention now"
- Replace "stakeholders" with "people involved" or name them directly
- Never use: audit, compliance, stakeholder, remediation, deliverable, KPI, ROI
- Tone: empathetic, direct, human — the council is a group of wise advisors, not a QA team
- Seat output style: conversational paragraphs for emotional content; no bullet points when the finding involves grief, fear, identity, or relationships
- Verdict language: "choose", "say", "stop", "start", "tell them", "let go of"

### Business Domain
- Replace "findings" with "observations"; replace "deliverable" with "initiative" or "proposal"
- Replace "priority: HIGH" with "strategic priority"
- Tone: professional, strategic, ROI-aware — frame everything in terms of value and risk
- Seat output style: structured with business impact framing; quantify where possible
- Verdict language: "invest", "divest", "accelerate", "pause", "acquire", "partner", "exit"

### Creative Domain (writing, design, product, art)
- Replace "findings" with "observations" or "instincts"; replace "constraints" with "creative boundaries"
- Tone: generative, curious, honest about craft — the council serves the work, not the creator's ego
- Seat output style: mix of observation and question — seats notice things and ask what they mean
- Verdict language: "commit to", "cut", "rebuild", "release", "sit with it longer"
- Seat 12 (Innovation) gets more weight in creative domains — breakthrough reframes are the point

### Rule
For non-technical domains, the report should read like advice from a wise council of advisors, not like a QA audit report or a consulting deck. If the language feels corporate, clinical, or bureaucratic when the situation is human — rewrite it. The test: would a thoughtful person read this and feel understood, or would they feel processed?
